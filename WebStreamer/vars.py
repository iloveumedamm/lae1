...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(getenv.get("API_ID", "26305247"))
    API_HASH = str(getenv.get("API_HASH",  "20ca7e6687c281e11782856c7efd0ff7"))
    BOT_TOKEN = str(getenv.get("BOT_TOKEN", "6257817586:AAHiHfYz_Ykn_n1QHgE7o1aRdOn5Gxg6M4U"))
