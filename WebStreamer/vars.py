...
class Var(object):
    ...
    API_HASH = str(environ.get("API_HASH",  "20ca7e6687c281e11782856c7efd0ff7"))
    BOT_TOKEN = str(environ.get("BOT_TOKEN", "6257817586:AAHiHfYz_Ykn_n1QHgE7o1aRdOn5Gxg6M4U"))
    ...
    BIND_ADDRESS = str(environ.get("WEB_SERVER_BIND_ADDRESS", "172.67.211.60"))
